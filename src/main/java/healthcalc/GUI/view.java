...
public class view {
    ...
    private void initialize() {
        ...
        separatorvertical.setBounds(250, 11, 200, 550);
        ...
        separatorHorizontal1.setBounds(250, 420, 500, 550);
        separatorHorizontal1.setForeground(Color.BLACK);
        frame.getContentPane().add(separatorHorizontal1);

        JSeparator separatorHorizontal2 = new JSeparator(SwingConstants.HORIZONTAL);
        separatorHorizontal2.setBounds(250, 90, 500, 550);
        separatorHorizontal2.setForeground(Color.BLACK);
        frame.getContentPane().add(separatorHorizontal2);
